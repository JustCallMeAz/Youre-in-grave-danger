...
public class DeathInfoManager extends PersistentState {
    ...
    public static PersistentState.Type<DeathInfoManager> getPersistentStateType(ServerWorld world) {
        return new PersistentState.Type<>(DeathInfoManager::new, nbt -> DeathInfoManager.fromNbt(nbt, world.getServer()), DataFixTypes.LEVEL);
    }
